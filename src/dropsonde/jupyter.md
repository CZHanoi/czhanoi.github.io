...
|         DSW         | CPU  | Mem (GB) | Port  |  jupyter  |  -   |
| :-----------------: | :--: | :------: | :---: | :-------: | :--: |
|   The_Mighty_God    |  60  |   1450   | 30336 | dsw-33823 | 2604 |
|     Counsellor      |  45  |   1500   | 30300 | dsw-30794 | 1515 |
|      Wonderful      |  18  |   630    | 30106 | dsw-37463 |  -   |
| Ever_lasting_father |  25  |   980    | 30505 | dsw-37377 | 1409 |

```bash
ssh -N -L 2604:127.0.0.1:8088 -R 127.0.0.1:17897:127.0.0.1:7897 -p 30336 zy_22111220045@10.193.2.99

ssh -N -L 2604:127.0.0.1:8088 -p 30143 zy_22111220045@10.193.2.99
# http://localhost:2604/dsw-33823/lab/tree/Tanzimat
```



```bash
ssh -N -L 1515:127.0.0.1:8088 -p 30300 zy_22111220045@10.193.2.99 -R 127.0.0.1:17897:127.0.0.1:7897

ssh -N -L 1515:127.0.0.1:8088 -p 30300 zy_22111220045@10.193.2.99
# http://localhost:1515/dsw-30794/lab/tree/Janissary
```



```bash
ssh -N -L 1409:127.0.0.1:8088 -p 30505 zy_22111220045@10.193.2.99 -R 127.0.0.1:17897:127.0.0.1:7897
ssh -N -L 1409:127.0.0.1:8088 -p 30505 zy_22111220045@10.193.2.99
# http://localhost:0917/dsw-37377/lab/tree/
```
...
ssh -N -L 2604:127.0.0.1:8088 -p 30143 zy_22111220045@10.193.2.99
# http://localhost:2604/dsw-33823/lab/tree/
```
